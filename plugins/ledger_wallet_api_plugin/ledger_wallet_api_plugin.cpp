...
namespace eosio { namespace detail {
    struct ledger_wallet_api_plugin_empty {};
}}

FC_REFLECT(eosio::detail::ledger_wallet_api_plugin_empty, );
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     eosio::detail::ledger_wallet_api_plugin_empty result;
...
void ledger_wallet_api_plugin::plugin_startup() {
    ilog("starting ledger_wallet_api_plugin");
    // lifetime of plugin is lifetime of application
    auto& wallet_mgr = app().get_plugin<ledger_wallet_plugin>().get_wallet_manager();
